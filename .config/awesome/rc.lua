...
beautiful.init("/home/gregory/.config/awesome/themes/default/theme.lua")
...
globalkeys = awful.util.table.join(
    -- 240 = 1920 / 8; 35 ~= (67/2 = 1080/16)
    awful.key({ }, "F3", function() scratchpad.toggle("urxvtc -name scratch-term -geometry 240x35+0+0") end),
